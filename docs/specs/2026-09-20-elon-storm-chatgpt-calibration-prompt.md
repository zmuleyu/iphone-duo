...
Upload only these two read-only visual references before sending the prompt:

1. `ChatGPT Image 2026年9月19日 12_43_10.png` — style, face, wardrobe, hand-cue, and lighting reference; it has a baked background and is not alpha evidence.
2. `Te8Tr.jpg` — full-body proportion and foot-placement reference; its environment must not be reproduced.

```text
Create the first calibration window for the internal-only Real Elon character layer of an original iPhone Duo fold-led motion study.

This is generator window 1 of manifest elon-storm-character-v1.0-calibration. The result is an internal character-compositing test, not an endorsement, advertisement, public release, political statement, or depiction of speech or conduct. Do not show a phone, Apple product, logo, company mark, quote, text, or product-hold gesture.

Already retained and not to be regenerated:
- ELON-REF-001: uploaded front-facing editorial Elon likeness with a compact right-hand cue. Use only as style/identity/lighting reference; its dark background is baked and must not be copied.
- ELON-REF-002: uploaded full-body neutral Elon reference. Use only for body proportions and safe head/foot margins; its environment and circuitry must not be copied.

Complete these new assets in order:
- ELON-CAL-001
- ELON-CAL-002

Shared style lock (proposal for calibration, not a claim of final acceptance):
- One recognizable but simplified editorial caricature of Elon Musk per file; no photoreal skin or photographic texture.
- Clean vector-like/polygonal planes with limited shading and crisp edges. The silhouette must read first at small folded-screen size.
- Black tee or short dark jacket. Keep face, proportions, wardrobe, and lighting consistent across both outputs.
- Cool cyan rim on screen-left and restrained warm amber rim on screen-right, with neutral front illumination.
- One subject only on a genuinely transparent background. No baked scene, floor, vignette, smoke, shadow cloud, UI, text, label, signature, logo, company object, other person, robot, collage, contact sheet, character sheet, or second pose.
- Every generated asset must show the complete body: both hands, usable fingers, both legs, and both shoes fully inside frame, with about 10–15% transparent padding on every side. Prefer a vertical 4:5 canvas.
- Do not reproduce any recognizable STORM II shot, school setting, uniform, blocking, choreography, grading, or composition.

Execution rules:
1. Generate one independent transparent PNG for each ID. One result must correspond to exactly one ID.
2. After each image, inspect: identity/style consistency, pose/orientation, small-size silhouette, complete anatomy, crop/padding, absence of forbidden elements, and whether transparency is real rather than a dark or checkerboard-looking baked background.
3. State the concrete self-check result for that ID. If exactly one clear blocker exists, perform at most one targeted repair. Preserve already-correct regions.
4. If a localized/countable defect repeats after one whole-image repair, use a local edit on the best candidate rather than generating a new whole image. At most one local-edit follow-up.
5. Do not ask for approval between IDs. Continue through ELON-CAL-002, then return the summary table.

Assets:

ELON-CAL-001 — Closed/RUMOR source
- Pose: full body in restrained neutral stance; body and head in profile-to-three-quarter facing screen-left, designed for later placement in the screen-right third looking toward the hinge. This is a source cutout, so keep the entire body even though the final composition may crop to face/shoulder.
- Must have: recognizable editorial Elon likeness; strong profile/head silhouette; both hands and all fingers visible; both shoes visible; black tee or short dark jacket; consistent cyan-left/amber-right rim; clean non-glowing alpha edge; 10–15% transparent padding.
- Must not have: cropped anatomy; front-facing hero pose; wave; product-hold or endorsement gesture; background/floor/shadow cloud; device; logo; text; other person; robot; scene; collage; multiple poses.

ELON-CAL-002 — Opening/FORMATION source
- Pose: full body in a restrained half-turn. Torso remains three-quarter toward screen-left while the head settles nearer front; one small hinge-ward step toward screen-left creates a clear weight shift. Hands stay compact, natural, and readable rather than theatrical.
- Must have: same face, proportions, wardrobe, and lighting as ELON-CAL-001; readable half-turn and weight shift; complete hands/fingers and both shoes; strong thumbnail silhouette; clean non-glowing alpha edge; 10–15% transparent padding.
