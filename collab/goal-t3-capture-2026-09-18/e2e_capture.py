...
GOAL = Path(r"D:\projects\creative_group\iphone-duo\collab\goal-t3-capture-2026-09-18")
...
FORMATS = sys.argv[2].split(",") if len(sys.argv) > 2 else ["16x9", "9x16", "1x1"]
...
async def main():
    ...
    (GOAL / "safe_rects.json").write_text(json.dumps(rects, indent=2), encoding="utf-8")
